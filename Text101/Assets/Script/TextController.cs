...
public class TextController : MonoBehaviour {
	...
	private enum States {
		...
		corridor_0, stairs_0, stairs_1, stairs_2, corridor_1, corridor_2,
		courtyard, floor, corridor_3, closet_door, in_closet
		};
	...
	{
		text.text = "You start walking up the stairs towars the outside light. " +
